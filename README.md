...
![My Skills](https://skillicons.dev/icons?i=cs,golang,javascript,python,regex,flask,django,fastapi,nodejs,expressjs,jquery,npm,selenium,sqlite,html,css,git,mysql,wordpress,mongodb,postman,linux,kali,ubuntu,bash,obsidian,unity&theme=dark)
...
![Learn Skills](https://skillicons.dev/icons?i=rust,php,laravel,redux,electron,vuejs,vite,nextjs,graphql,tailwind,arch,docker,nginx&theme=dark)
