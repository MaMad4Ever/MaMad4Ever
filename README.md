...
![My Skills](https://skillicons.dev/icons?i=cs,go,js,python,regex,flask,django,fastapi,selenium,sqlite,html,css,git,mysql,wordpress,mongodb,postman,linux,kali,ubuntu,bash,notion,unity&theme=dark)
...
![Learn Skills](https://skillicons.dev/icons?i=rust,ts,kotlin,php,laravel,jquery,nodejs,react,redux,electron,vuejs,vite,expressjs,npm,nextjs,graphql,tailwind,arch,docker,obsidian,nginx&theme=dark)
