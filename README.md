...
![My Skills](https://skillicons.dev/icons?i=cs,javascript,python,regex,flask,django,fastapi,nodejs,alpinejs,jquery,npm,selenium,sqlite,html,css,git,mysql,wordpress,mongodb,postman,linux,bash,obsidian&theme=dark)
...
![Learn Skills](https://skillicons.dev/icons?i=golang,rust,php,laravel,redux,redis,electron,vuejs,vite,nextjs,expressjs,graphql,tailwind,bootstrap,arch,docker,nginx&theme=dark)
